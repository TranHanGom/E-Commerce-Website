...
public class qlChiTietSanPham extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String url = "";
		if(request.getParameter("MaSP")=="" ||request.getParameter("NgaySX")==""||request.getParameter("HanSD")==""||request.getParameter("XuatSu")==""||request.getParameter("NoiSX")=="") {
		...
		try  {
				switch (command) {
				case "insert":
				ChiTietSPDAO.insert_ChiTietSanPham(new ChiTietSanPham(MaSP,NgaySX,HanSD,XuatSu,NoiSX));
				url = "/ChiTietSanPhamQL";
				break;
				case "update":
					ChiTietSPDAO.update_ChiTietSanPham(new ChiTietSanPham(MaSP,NgaySX,HanSD,XuatSu,NoiSX));
					url = "/ChiTietSanPhamQL";
					break;
				}
			}
