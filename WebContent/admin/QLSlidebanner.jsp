...
<html>
<head>
<title>Manage SlideBanner</title>
...
<div id="wrapper">
	...
	<!-- memnu -->
	<div id="rightContent">
	<h3>Manage SlideBanner</h3>
	<a href = "addSlideBanner">Add slidebanner</a>
		...
		<table class="data">
			...
			<% int i=1;
				...
				<center>
				<a href="update_slidebanner?command=update&ma_slide=<%=s.getSlidebannerID()%>">Edit</a>&nbsp;&nbsp; | &nbsp;&nbsp;
				<a href="qlSlideBanner?command=delete&ma_slide=<%=s.getSlidebannerID()%>">Delete</a>
				</center>
				</td>
