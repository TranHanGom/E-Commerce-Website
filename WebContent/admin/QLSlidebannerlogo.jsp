...
<div id="wrapper">
	...
	<!-- memnu -->
	<div id="rightContent">
	<h3>Manage SlideLogo</h3>
	<a href = "addSlidebannerLogo">Add slideLogo</a>
		...
		<table class="data">
			...
			<% int i=1;
				...
				<center>
				<a href="update_slidebannerLogo?command=update&ma_slide=<%=s.getSlidebannerLogoID()%>">Edit</a>&nbsp;&nbsp; | &nbsp;&nbsp;
				<a href="qlSlidebannerLogo?command=delete&ma_slide=<%=s.getSlidebannerLogoID()%>">Delete</a>
				</center>
				</td>
