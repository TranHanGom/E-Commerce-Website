...
<div id="wrapper">
	...
	<a id=add href = "addChuyenMuc">Add Category</a>
		...
		<table class="data">
			...
			<% int i=1;
				...
				<center  id="but">
				<a href="Update_ChuyenMuc?command=update&ma_CM=<%=c.getMaCM()%>">Edit</a>&nbsp;&nbsp; | &nbsp;&nbsp;
				<a href="qlChuyenMuc?command=delete&ma_CM=<%=c.getMaCM() %>">Delete</a>
				</center>
				</td>
